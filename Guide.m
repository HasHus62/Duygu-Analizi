...
% Last Modified by GUIDE v2.5 13-Jul-2021 21:55:46
...
HHK=get(handles.edit4,'String');
H=load("Egitim_Kumem.mat")
reportsNew = [HHK];
documentsNew = preprocessText(reportsNew);
XNew = doc2sequence(H.enc,documentsNew,'Length',H.sequenceLength);
labelsNew = classify(H.net,XNew)
set(handles.edit5,'String',labelsNew);
dgr = table2cell(H.perf_Olc.DetailedAccuracyByClass);
set(handles.edit6,'String',dgr(4,5));
set(handles.edit10,'String',H.perf_Olc.AccuracyRate);
